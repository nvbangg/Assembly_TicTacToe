...
.data               
    ...
    bang db 13,10, '               |     |     ',13,10,13,10, '          -----------------',13,10,13,10, '               |     |     ',13,10,13,10, '          -----------------',13,10,13,10, '               |     |     ',13,10,'$' ; giao diện bảng trên màn hình  
    pos dw 3+1+10,7+3+10,11+5+10,29+17+30,33+19+30,37+21+30,55+33+50,59+35+50,63+37+50 ; vị trí các 'ki_tu' trong 'bang' để cập nhật
    ...
    turn_begin db 'X'       ; lưu lượt chơi đầu mỗi vòng 
